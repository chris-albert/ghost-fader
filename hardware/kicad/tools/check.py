...
EXPECTED = [
    ('GND', ['J1.S', 'J1.TN', 'J2.S', 'J2.TN', 'J3.S', 'J4.S', 'U1.1', 'U2.1', 'U3.5', 'U3.10', 'U3.15', 'U4.5', 'U4.10', 'U4.15',
             'U6.3', 'U7.3', 'U9.1', 'U9.16', 'SW1.1', 'SW1.2', 'SW1.3', 'SW1.4', 'LED1.1', 'PS1.1', 'PS1.7'],
     ['C1', 'C2', 'C7', 'C8', 'C9', 'C10', 'C15', 'C16', 'R4', 'R8', 'R15', 'C11', 'C12', 'C13'] + DEC_P15 + DEC_M15 + DEC_P5),
    ('+15V', ['U1.7', 'U2.7', 'U3.12', 'U4.12', 'U5.8', 'U6.6', 'U7.6'], ['L1', 'C12'] + DEC_P15),
    ('-15V', ['U1.4', 'U2.4', 'U3.13', 'U4.13', 'U5.4', 'U6.5', 'U7.5'], ['L2', 'C13'] + DEC_M15),
    ('+5V', ['PS1.2', 'U3.1', 'U3.4', 'U4.1', 'U4.4'], ['FB1', 'C11'] + DEC_P5),
    ('+3V3', ['U9.17'], ['R1', 'R14']),
    ('USB_5V', ['U9.15'], ['FB1']),
    ('L tip', ['J1.T', 'U1.3'], ['C1']), ('L ring', ['J1.R', 'U1.2'], ['C2']),
    ('R tip', ['J2.T', 'U2.3'], ['C7']), ('R ring', ['J2.R', 'U2.2'], ['C8']),
    ('SENSE_L', ['J1.RN', 'U9.4'], ['R1']), ('SENSE_R', ['J2.RN', 'U9.5'], ['R14']),
    ('L_SE', ['U1.5', 'U1.6'], ['C3', 'C5']), ('R_SE', ['U2.5', 'U2.6'], ['C4', 'C6']),
    ('U3 inL', ['U3.16'], ['C3']), ('U3 inR', ['U3.9'], ['C4']), ('U4 inL', ['U4.16'], ['C5']), ('U4 inR', ['U4.9'], ['C6']),
    ('SCLK', ['U9.28', 'U3.6', 'U4.6'], []), ('SDI', ['U9.13', 'U3.3'], []), ('U3_SDO', ['U3.7', 'U4.3'], []),
    ('/CS', ['U9.12', 'U3.2', 'U4.2'], []), ('/MUTE', ['U9.11', 'U3.8', 'U4.8'], ['R15']),
    ...
    ('DIP0', ['U9.6', 'SW1.8'], []), ('DIP1', ['U9.7', 'SW1.7'], []), ('DIP2', ['U9.8', 'SW1.6'], []), ('DIP3', ['U9.9', 'SW1.5'], []),
    ('LED drive', ['U9.10'], ['R16']), ('LED anode', ['LED1.2'], ['R16']),
    ('PS1 +out', ['PS1.6'], ['L1']), ('PS1 -out', ['PS1.8'], ['L2']),
]
NC = ['U1.8', 'U2.8', 'U4.7', 'U9.2', 'U9.3', 'U9.14'] + [f'U9.{n}' for n in range(18, 28)] + ['J3.RN', 'J3.TN', 'J4.RN', 'J4.TN', 'PS1.3']
